...
@test "SOURCE-UAT.md in remediation phase is not treated as UAT issues" {
  ...
  # SOURCE-UAT is a copy of the original milestone UAT — should be ignored
  cat > .vbw-planning/phases/01-remediate-v1-setup/01-SOURCE-UAT.md <<'EOF'
---
phase: 01
status: issues_found
---
